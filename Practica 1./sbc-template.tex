...
\maketitle
 \textbf{Ejercicio 1 \\}
\textit{Demuestra la correctud de la funcióńon mapeo definida en Haskell, es decir:\\
Para cualesquiera tipos a y b, funcíon f que dado un elemento de tipo a devuelve un
