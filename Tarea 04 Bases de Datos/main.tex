...
\begin{enumerate}
   ...
   \end{center}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        $\pi$ idcliente, nombrecliente, direccion, estado, nacimiento ($\sigma$ numprestamo $\neq$ null $\lor$ numcta $\neq$ null ($\sigma$ estado = 'CHIAPAS' cliente ${\tiny \textifsym{d|><|}}$ prestatario ${\tiny \textifsym{d|><|}}$ ctacliente))
        ...
        $\pi$ idcliente, nombrecliente, numprestamo, importe ($\sigma$ importe $\geq$ 80000 $\land$ numcta = null (cliente $\bowtie$ prestatario $\bowtie$ prestamo ${\tiny \textifsym{d|><|}}$ ctacliente))
    ...
    $\pi$ numsucursal, nombresucursal, estado, activo ($\sigma$ estado = 'GUERRERO' $\land$ estadosucursal = 'GUERRERO' (cliente $\bowtie$ ctacliente $\bowtie$ cuenta $\bowtie$ $\rho$ estadosucursal$\leftarrow$ estado (sucursal)))
        ...
        $\pi$ idcliente, nombrecliente, direccion, estado, nacimiento $\sigma$ numprestamo $\neq$ null xor numcta $\neq$ null (cliente ${\tiny \textifsym{d|><|}}$ prestatario ${\tiny \textifsym{d|><|}}$ ctacliente)
