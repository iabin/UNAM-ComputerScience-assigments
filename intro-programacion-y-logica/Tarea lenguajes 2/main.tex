...
a las n variables ligadas, lo cual es contradicción, por lo tanto $|L|\leq|DL|$.
\section*{Referencias}
\begin{thebibliography}{9}
\bibitem{cppref}
FING -- UDELAR, 5 sept 2017.\\
\url{https://www.fing.edu.uy/~darosa/eval08Logica-de-predicados.pdf}

\bibitem{brown}
Brown, 5 sept 2017.\\
\url{http://papl.cs.brown.edu/2014/Interpreting_Functions.html#%28part._eager-lazy-subst%29}

\bibitem{etnasoft}
Etnasoft, 5 sept 2017.\\
\url{http://www.etnassoft.com/2011/06/03/estudiando-la-funcion-width-en-javascript-y-el-porque-no-hay-que-usarla/}
\end{thebibliography}
\end{document}
f {fun y {+ x y}}
x 5
